...
describe("validateProfileData.test", () => {
    ...
    test("with filled firstname and lastname", () => {
        const profileWithFirstnameLastname: Profile = { ...p, firstname: "test", lastname: "test" };
    ...
    test("with correct firstname, lastname and age", () => {
        const profileWithFirstnameLastnameAge: Profile = { ...p, firstname: "test", lastname: "test", age: 20 }
    ...
    test("with correct firstname, lastname, age and country", () => {
        const defaultProfileWithAllRequirePropsFilled: Profile = { ...p, firstname: "test", lastname: "test", age: 20, country: Country.Belarus }
        const result = validateProfileData(defaultProfileWithAllRequirePropsFilled);
